...
def main():
    ...
    if inpt == 1:
        ...
        dataframe_list+=FbSearch(dataframe_list)
        dataframe_list+=OlxSearch(dataframe_list)
    elif inpt == 0:

        dataframe_list+=FbSearch(dataframe_list)
        dataframe_list+=OlxSearch(dataframe_list)
        Visualizations
        sendMsg(dataframe_list)
    elif inpt == 4:
        sendMsg(dataframe_list)
    else:
        print("Default")
